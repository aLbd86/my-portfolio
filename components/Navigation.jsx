const Navigation = () => {
  return (
    <>
      <nav className="flex">
        <div className="bg-neutral left-0 top-0 hidden h-screen w-20 gap-10 md:fixed md:flex md:flex-col md:items-center md:justify-around">
          {/* navbar - menu */}
          <div className=" flex items-center ">
            <ul
              className=" bg-neutral flex rotate-180 flex-row-reverse items-center justify-center gap-12"
              style={{ writingMode: "vertical-rl" }}
            >
              <li className="text-base-100 text-lg">
                <a href="/">Accueil</a>
              </li>
              <li className="text-base-100 text-lg">
        ...
        <div className="fixed bottom-0 z-50 flex  ">
          <ul className="menu menu-horizontal bg-neutral flex w-screen items-center justify-center gap-2 p-4 md:hidden">
            <li className="flex">
              {/* Home */}
              <a href="/" className="tooltip ">
                ...
                >
                  <path
                    d="M12.5 22.5V18.75C12.5 18.0869 12.7634 17.4511 13.2322 16.9822C13.7011 16.5134 14.337 16.25 15 16.25C15.663 16.25 16.2989 16.5134 16.7678 16.9822C17.2366 17.4511 17.5 18.0869 17.5 18.75V22.5M2.5 9.99998L14.665 3.91748C14.769 3.86554 14.8837 3.8385 15 3.8385C15.1163 3.8385 15.231 3.86554 15.335 3.91748L27.5 9.99998"
                    stroke="white"
                    stroke-width="2"
                  ...
                  />
                  <path
                    d="M25 13.75V23.75C25 24.413 24.7366 25.0489 24.2678 25.5178C23.7989 25.9866 23.163 26.25 22.5 26.25H7.5C6.83696 26.25 6.20107 25.9866 5.73223 25.5178C5.26339 25.0489 5 24.413 5 23.75V13.75"
                    stroke="white"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <li className="flex">
              ...
              <a href="/music" className="tooltip">
                ...
                >
                  <path
                    d="M13.75 3.75H22.5V6.25H16.25V22.5C16.2498 23.6006 15.8864 24.6704 15.2162 25.5435C14.546 26.4165 13.6065 27.044 12.5433 27.3287C11.4801 27.6134 10.3527 27.5393 9.33594 27.118C8.31916 26.6967 7.4698 25.9516 6.9196 24.9984C6.3694 24.0452 6.14909 22.937 6.29284 21.8458C6.43659 20.7546 6.93637 19.7414 7.71467 18.9631C8.49297 18.1849 9.5063 17.6853 10.5975 17.5416C11.6887 17.398 12.7968 17.6184 13.75 18.1687V3.75ZM13.75 22.5C13.75 21.837 13.4866 21.2011 13.0178 20.7322C12.5489 20.2634 11.913 20 11.25 20C10.587 20 9.95108 20.2634 9.48224 20.7322C9.0134 21.2011 8.75001 21.837 8.75001 22.5C8.75001 23.163 9.0134 23.7989 9.48224 24.2678C9.95108 24.7366 10.587 25 11.25 25C11.913 25 12.5489 24.7366 13.0178 24.2678C13.4866 23.7989 13.75 23.163 13.75 22.5Z"
                    fill="white"
                  />
                </svg>
              </a>
