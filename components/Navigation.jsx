            ...
            <li className="flex">
              ...
              <a href="/music" className="tooltip">
                ...
                >
                  ...
                  <path
                    d="M14.5 3H23.25V5.5H17V21.75C16.9998 22.8506 16.6364 23.9204 15.9662 24.7935C15.296 25.6665 14.3565 26.294 13.2933 26.5787C12.2301 26.8634 11.1027 26.7893 10.0859 26.368C9.06916 25.9467 8.2198 25.2016 7.6696 24.2484C7.1194 23.2952 6.89909 22.187 7.04284 21.0958C7.18659 20.0046 7.68637 18.9914 8.46467 18.2131C9.24297 17.4349 10.2563 16.9353 11.3475 16.7916C12.4387 16.648 13.5468 16.8684 14.5 17.4187V3ZM14.5 21.75C14.5 21.087 14.2366 20.4511 13.7678 19.9822C13.2989 19.5134 12.663 19.25 12 19.25C11.337 19.25 10.7011 19.5134 10.2322 19.9822C9.7634 20.4511 9.50001 21.087 9.50001 21.75C9.50001 22.413 9.7634 23.0489 10.2322 23.5178C10.7011 23.9866 11.337 24.25 12 24.25C12.663 24.25 13.2989 23.9866 13.7678 23.5178C14.2366 23.0489 14.5 22.413 14.5 21.75Z"
                    fill="white"
                  />
                </svg>
              </a>
